...
$questions = array(
    ...
    array(
        "questions" => array(
            "Which is not a type of Web Developer?",
            "Out of these languages which is not commonly used?",
            "When was the first computer virus written?",
            "What is the syntax of many programming languages inspired by?",
            "What programming language was written by Google?"
        ),
        "answers" => array(
            array("Front-end", "Side-end", "Back-end", "Full-stack", "UI/UX"),
            array("CSS", "Javascript", "Objective-C", "HTML", "Python"),
            array("1960s", "1980s", "1990", "1970", "1950s"),
            array("natural languages", "mostly animals", "language of the sea", "the names of gems", "names of famous people"),
    ...
    array(
        "questions" => array(
            "What type of code is used for styles?",
            "How many programming languages are there?",
            "How to view the HTML of a page in browser",
            "What code is involved in Web Programming",
            "What was the world's first computer programmer like?"
        ),
        "answers" => array(
            array("PHP", "HTML", "CSS", "Javascript", "C#"),
            array("Around 700", "Around 500", "Around 1,000", "About 200", "Just a couple"),
            array("highlight the link and press 'ctrl+p'", "right-click and view next page", "click on the lock button on search bar", "right-click and view QR code", "right-click on page and view page source"),
            array("CSS", "HTML", "All of the above", "PHP", "Javascript"),
            array("tall male engineer", "female talented scientist", "short female typer", "renowned male engineer", "renowned female mathematician")
        ),
